 ...
 * Data is fetched from MongoDB via the store layer on each request.
 *
...
const { getAllRecords } = require("../data/store");
...
// ---------------------------------------------------------------------------
// Main search entry point (async — fetches from MongoDB)
// ---------------------------------------------------------------------------
async function search({ query, mode, targetField, filters = {}, page = 1, pageSize = 50 }) {
...
// ---------------------------------------------------------------------------
// Suggest / autocomplete (async)
// ---------------------------------------------------------------------------
async function suggest(prefix, scope = "all") {
